 ...
 *                     $ref: '#/components/schemas/StudentResponse'
 */
router.get('/match', studentController_1.findMatchingStudents);
/**
 * @swagger
 * /api/students/{id}:
 *   get:
 ...
 */
router.post('/:studentId/lessons/:lessonId', studentController_1.assignStudentToLesson);
/**
 * @swagger
 * /api/students/{studentId}/lessons/{lessonId}:
 *   delete:
 ...
 */
router.delete('/:studentId/lessons/:lessonId', studentController_1.removeStudentFromLesson);
